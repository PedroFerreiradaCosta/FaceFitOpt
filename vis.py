...
def plot_bo(mu, sigma, x, y, comp1='Component 1', comp2 = 'Component 2'):
    ...
    ax0.set_xlabel(comp1, fontdict=font_dict_label)
    ax0.set_ylabel(comp2, fontdict=font_dict_label)
    fig.colorbar(fig0)

    ax1 = fig.add_subplot(122)
    fig1 = ax1.pcolormesh(X0p, X1p, Zsigma)
    ax1.set_title('Gaussian Process Variance', fontdict=font_dict_title)
    ax1.set_xlabel(comp1, fontdict=font_dict_label)
    ax1.set_ylabel(comp2, fontdict=font_dict_label)
    fig.colorbar(fig1)
    ...
    ax2.set_xlabel(comp1, fontdict=font_dict_label3)
    ax2.set_ylabel(comp2, fontdict=font_dict_label3)
    ...
    ax3.set_xlabel(comp1, fontdict=font_dict_label3)
    ax3.set_ylabel(comp2, fontdict=font_dict_label3)
    ...
    ax4.set_xlabel(comp1, fontdict=font_dict_label3)
    ax4.set_ylabel(comp2, fontdict=font_dict_label3)
